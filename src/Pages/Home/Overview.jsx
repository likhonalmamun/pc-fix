...
const Overview = () => {
  return (
    <div className="my-10 shadow-xl border-2 bg-slate-50 border-blue-500 rounded-xl p-2 sm:p-7">
      <h1 className="sm:text-3xl text-xl mb-4 text-blue-600 text-center font-semibold">
        My Service Overview
      </h1>
      <div className="flex flex-wrap justify-around ">
        <div className="rounded-xl w-[80%] mx-auto my-3 text-center sm:w-auto  shadow-xl bg-white p-4">
